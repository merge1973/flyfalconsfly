  ...
  return (
    <Layout title="Politics" description="The politics hub for Fly Falcons Fly News, a student run news website.">
      <div className="grid grid-cols-2 grid-rows-1 p-4 pt-8 gap-4">
        <h1 className="pl-6 text-5xl">Politics</h1>
        <a href="/articles/politics" className="justify-self-end w-1/2 relative inline-flex items-center py-3 pl-4 pr-12 overflow-hidden font-semibold text-indigo-600 transition-all duration-150 ease-in-out rounded hover:pl-10 hover:pr-6 outline outline-2 group">
      ...
      <p className="pl-12">The politics hub for Fly Falcons Fly News.</p>
